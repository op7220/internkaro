...
class ListingJobScreen extends StatefulWidget {
  var subcategory;
  ListingJobScreen({this.subcategory});
  @override
  _ListingJobScreenState createState() => _ListingJobScreenState();
}

class _ListingJobScreenState extends State<ListingJobScreen> {
